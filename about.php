...
<main>
  <div class="about-wrap">
    ...
    <p>Welcome to The Nation's Bookstore, where every page turned is a step toward a more inspired and empowered community.</p>
    <p>As a student deeply immersed in the worlds of Enterprise Architecture, Human-Computer Interface, and Software Development, I've seen firsthand how the right information — be it a complex coding manual or a transformative piece of literature — can reshape the way we build the future. This store was born from that belief: that access to knowledge should be as seamless and impactful as a well-designed system.</p>
  </div>
</main>
